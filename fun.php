...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT * FROM funcionarios WHERE id = '$id' AND Senha = '$senha'";
    
    $result = mysqli_query($conexao, $query);

    if(mysqli_num_rows($result) == 1) {
        // Se a senha e o ID correspondem, redireciona para a página de edição
        header("Location: apagar_fun.php?id=$id");
        exit();
    } else {
        ...
        echo "<script>window.location = 'fun.php';</script>"; 
    }
}
?>
...
<body>
    ...
    <fieldset>
    <legend><b>Confirmação de identificação</b></legend>
        <br>
        <div class="inputBox">
